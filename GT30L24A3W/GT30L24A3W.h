...
extern void r_dat_bat(unsigned long  ReadAddr,unsigned int  NumByteToRead,unsigned char* pBuffer);
...
unsigned long Unicode1_Shift_Jis_GetData(unsigned int code,unsigned char *DZ_Data);
...
unsigned long code1Page_UC(unsigned char code,unsigned char cpsel);/////////////////////////
